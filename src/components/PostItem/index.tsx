...
export default function PostItem({
    ...
    async function handleDeletePost(post: Post) {
        const element = getById("post" + post.id) as HTMLLIElement;
    ...
    return (
        <li
            id={"post" + post.id}
            className={
                "w-full border-background overflow-hidden p-0 m-0 " +
                (post?.new ? "postAdd" : "")
            }
        >
            <div
                className={
                    "pt-5 flex h-full flex-col gap-3 mb-20" + borderClass
                }
            >
                <header className="flex flex-row items-center justify-between">
                    ...
                    >
                        ...
                        <SlOptions
                            className={
                                showPostOptions ? "optionsIn" : "optionsOut"
                            }
                            size={18}
                        />
                    </button>
                ...
                <div className="flex flex-row items-center justify-between text-sm">
                    <div className="flex flex-row justby-between items-center gap-4">
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <p className="text-text-inactive pt-[2px]">
                                {postLikes} likes
                            </p>
                        </div>
                    </div>
